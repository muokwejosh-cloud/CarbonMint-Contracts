...
The CarbonMint smart contract needs a clear, documented approach to "prefer saturating math for aggregates" so the codebase stays consistent and auditable.
